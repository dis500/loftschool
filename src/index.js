...
function returnBadArguments(fn) {
    ...
    for (var i = 1; i < arguments.length; i++) {
        try{
            ...
            bad.push(arguments[i]);
        }
    }
    return bad;
}
/*
function nums_and_strings(a) {
    // if ((typeof a !== 'number') && (typeof a !== 'string')) {
    if (!((typeof a === 'number') || (typeof a === 'string'))) {
        throw new TypeError('Аргумент должен быть числом или строкой.');
    }
}

returnBadArguments(nums_and_strings, 34, 4, 'abc', [1, 2, 3], function() {}, 100, 'ещё строка');*/
